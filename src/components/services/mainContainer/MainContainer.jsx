    ...
    <>
      ...
      <section className={styles.ourServicesSection}>
        <OurServicesCard
          ...
          price="$80"
          age="Edades: 18-65 años • ⏱️ 25-40 min"
      ...
      <section className={styles.ourServicesSection}>
        <OurServicesCard
          ...
          price="$50"
          age="Edades: 16-65 años • ⏱️ 20-30 min"
      ...
      <section className={styles.ourServicesSection}>
        <OurServicesCard
          ...
          price="$80"
          age="Edades 18-65 años • ⏱️ 35-50 min"
